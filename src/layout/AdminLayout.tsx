...
// --- Hook: Device Detection with Breakpoints ---
    ...
    <div style={{ 
      ...
      <nav style={{ 
        ...
        >
          ...
          <span style={{ whiteSpace: "nowrap" }}>{t("common.students")}</span>
        </NavLink>
        <NavLink 
          to="/admin/attendance" 
          style={({ isActive }) => getLinkStyle(isActive, isMobile)} 
          onClick={handleNavClick}
        >
          <ClipboardCheck size={iconSize} style={{ flexShrink: 0 }} />
          <span style={{ whiteSpace: "nowrap" }}>{t("common.attendance")}</span>
        </NavLink>
        <NavLink 
          to="/admin/materials" 
          style={({ isActive }) => getLinkStyle(isActive, isMobile)} 
          onClick={handleNavClick}
        >
          <BookOpen size={iconSize} style={{ flexShrink: 0 }} />
          <span style={{ whiteSpace: "nowrap" }}>{t("common.materials")}</span>
        </NavLink>
        <NavLink 
          to="/admin/feedback" 
          style={({ isActive }) => getLinkStyle(isActive, isMobile)} 
          onClick={handleNavClick}
        >
          <MessageSquare size={iconSize} style={{ flexShrink: 0 }} />
          <span style={{ whiteSpace: "nowrap" }}>{t("common.feedback")}</span>
        </NavLink>
        <NavLink 
          to="/admin/progress" 
          style={({ isActive }) => getLinkStyle(isActive, isMobile)} 
        ...
        >
          ...
          <span style={{ whiteSpace: "nowrap" }}>{t("common.progress")}</span>
        </NavLink>
      </nav>
